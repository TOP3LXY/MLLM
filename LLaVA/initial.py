...
qwen_model = AutoModelForCausalLM.from_pretrained(qwen_tokenizer_dir, device_map='cuda:0', torch_dtype=torch.bfloat16)
clip_model = AutoModel.from_pretrained(clip_dir, device_map='cuda:0', torch_dtype=torch.bfloat16)
